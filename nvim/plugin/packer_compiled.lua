...
_G.packer_plugins = {
  ...
  ["cybu.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cybu.nvim",
  ...
  ["darcula-solid.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/darcula-solid.nvim",
  ...
  ["gitlinker.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/gitlinker.nvim",
  ...
  ["nvim-base16"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-base16",
  ...
  ["nvim-jqx"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-jqx",
    url = "https://github.com/gennaro-tedesco/nvim-jqx"
  },
  ["nvim-lsp-basics"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-lsp-basics",
  ...
  ["nvim-treesitter-textsubjects"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textsubjects",
    url = "https://github.com/RRethy/nvim-treesitter-textsubjects"
  },
  ["nvim-trevJ.lua"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-trevJ.lua",
  ...
  ["stabilize.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/stabilize.nvim",
    url = "https://github.com/luukvbaal/stabilize.nvim"
  },
  ["tabby.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/tabby.nvim",
  ...
  ["trim.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/trim.nvim",
  ...
  ["virtcolumn.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/virtcolumn.nvim",
    url = "https://github.com/xiyaowong/virtcolumn.nvim"
  },
  ["zenbones.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/zenbones.nvim",
